...
public class System extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        boolean deviceExtras = Utils.isPackageInstalled("com.aquarios.settings.device", getContext().getPackageManager());
        ...
        if (deviceExtras) device_extras.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setComponent(new ComponentName("com.aquarios.settings.device", "com.aquarios.settings.device.TouchscreenGestureSettings"));
