...
import com.aquarios.coralreef.helpers.Utils;
import com.aquarios.coralreef.navigation.BottomNavView;
import com.aquarios.coralreef.tabs.Lockscreen;
import com.aquarios.coralreef.tabs.Multitasking;
import com.aquarios.coralreef.tabs.Navigation;
import com.aquarios.coralreef.tabs.Statusbar;
import com.aquarios.coralreef.tabs.System;

import java.util.ArrayList;

import static com.aquarios.coralreef.helpers.Utils.tint;
...
public class CoralReef extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.coralreef);
    ...
    public void setLauncherIconEnabled(boolean enabled) {
        ...
        pm.setComponentEnabledSetting(new ComponentName(this, com.aquarios.coralreef.activities.LauncherActivity.class), newState, PackageManager.DONT_KILL_APP);
    }

    public boolean isLauncherIconEnabled() {
        PackageManager pm = getPackageManager();
        return (pm.getComponentEnabledSetting(new ComponentName(this, com.aquarios.coralreef.activities.LauncherActivity.class)) != PackageManager.COMPONENT_ENABLED_STATE_DISABLED);
    }
}
