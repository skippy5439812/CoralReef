 ...
 */
@RestrictTo(GROUP_ID)
public class BottomNavMenu extends ViewGroup implements MenuView {
    private final int mInactiveItemMaxWidth;
    private final int mInactiveItemMinWidth;
    private final int mActiveItemMaxWidth;
    private final int mItemHeight;
    private final OnClickListener mOnClickListener;
    private final BottomNavAnimationHelperBase mAnimationHelper;
    private static final Pools.Pool<BottomNavItemView> sItemPool =
    ...
    public BottomNavMenu(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        mAnimationHelper = new BottomNavAnimationHelperBase();
